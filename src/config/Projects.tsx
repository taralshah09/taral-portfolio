...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      'Built a leaderboard dashboard for GDG Cloud Jams, a hackathon event organized by Google Developer Groups. The dashboard displays the leaderboard of the hackathon and allows users to view the leaderboard of the hackathon.',
  ...
  },
  {
    ...
    description:
      'A Kanban board view that allows users to manage their tasks in a visual way. The board is divided into columns that represent the different stages of a task, and users can drag and drop tasks between columns to update their status.',
    image: '',
